 ...
 */
final class Version20240522093149 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE comment ADD user_id_id INT NOT NULL, ADD post_id INT NOT NULL, DROP user_id, DROP posts_id');
...
//        $this->addSql('CREATE INDEX IDX_9474526C9D86650F ON comment (user_id_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9474526C9D86650F ON comment');
//        $this->addSql('ALTER TABLE comment ADD user_id INT NOT NULL, ADD posts_id INT NOT NULL, DROP user_id_id, DROP post_id');
