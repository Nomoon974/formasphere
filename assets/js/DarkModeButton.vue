  ...
  <div class="tooltip-wip">
    ...
    <label for="checkbox" class="checkbox-label">
      <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 36 36">
        <circle cx="18" cy="18" r="18" fill="#c2c2c2"/>
        <g fill="#5B6876">
